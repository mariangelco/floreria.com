...
<body>
    ...
    if ($rol === 'Administrador') {
        echo '<header>
            ...
            <h1>¿En qué tabla se agregara el registro?</h1>
        </header>';
        echo '<nav>
            <ul>';
        echo '<li><a href="insertcategoria.php">Categoría</a></li>
                <li><a href="insertclientes.php">Cliente</a></li>
                <li><a href="insertempleados.php">Empleado</a></li>
                <li><a href="insertinventario.php">Inventario</a></li>
                <li><a href="insertcompra.php">Compras</a></li>
                <li><a href="insertproductos.php">Producto</a></li>
                <li><a href="insertproveedores.php">Proveedor</a></li>
                
                <li><a href="insertventas.php">Venta</a></li>';
        echo '</ul>
        </nav>';
    } elseif ($rol === 'Empleado') {
        echo '<header>
