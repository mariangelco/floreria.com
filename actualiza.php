...
<body>
    ...
    if ($rol === 'Administrador') {
        echo '<header>
            ...
            <h1>¿En qué tabla se modificara el registro?</h1>
        </header>';
        echo '<nav>
            <ul>';
        echo '<li><a href="updcategoria.php">Categoría</a></li>
                <li><a href="updclientes.php">Cliente</a></li>
                <li><a href="updempleados.php">Empleado</a></li>
                <li><a href="updinventario.php">Inventario</a></li>
                <li><a href="updproductos.php">Producto</a></li>
                <li><a href="updproveedores.php">Proveedor</a></li>';
        echo '</ul>
        </nav>';
    } elseif ($rol === 'Empleado') {
        echo '<header>
