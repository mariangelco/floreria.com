...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Clientes SET Telefono ='$tel', Correo = '$correo' WHERE Id_cliente = '$idcliente'";
...
<html>
<head>
    <title>Floreria actualizar cliente</title>
    <meta charset="UTF-8">
...
<body>
 <div class="header">
    ...
    <form action="updclientes.php" method="post">
    <h2>Actualizar cliente </h2>

            <label for="idcliente">Id cliente:</label>
            <input type="text" name="idcliente" required><br><br>
