...
<head>
    ...
    <title> Florería consulta clientes</title>
    <style>
        body {
...
<body>
    ...
    if ($result) {
        echo "<table>";
        echo "<tr><th>ID Cliente</th><th>Nombre</th><th>Apellido paterno</th><th>Apellido materno</th><th>Telefono</th><th>Correo</th></tr>";
