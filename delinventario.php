...
<html>
<head>
    <title>Floreria eliminar inventario</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="content">
        <form action="delinventario.php" method="post">
        <h2>Eliminar inventario</h2>

            <label for="id">ID del inventario a eliminar:</label>
            <input type="text" name="id" required><br><br>        
        
            <button type="submit" name="submit">Eliminar inventario</button>
