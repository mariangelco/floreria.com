...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO Empleados (Nombre, apellido_paterno, apellido_materno, Telefono, Activo, Correo) VALUES ('$nombre', '$apaterno', '$amaterno', '$tel','$act', '$correo')";
...
<html lang="es">
<head>
    <title>Floreria ingresar empleados</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="content">
        <form action="insertempleados.php" method="post">
            <h2>Insertar un nuevo empleado</h2>
