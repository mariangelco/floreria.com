...
<head>
    ...
    <title>Floreria consulta productos</title>
    <style>
        body {
...
<body>
    ...
    if ($result) {
        echo "<table>";
        echo "<tr><th>ID producto</th><th>ID inventario</th><th>ID categoria</th><th>nombre producto</th><th>Descripcion</th><th>Cantidad</th><th>Precio</th></tr>";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>" . $row['cant_total_prod'] . "</td>";
