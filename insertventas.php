...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO Ventas (id_cliente,fecha, importe, id_tipopago, Id_producto, Id_empleado) VALUES ('$idclien','$fecha', '$imp','$idpago', '$idprod', '$idemp')";
...
<html lang="es">
<head>
    <title>Floreria ingresar venta</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="content">
        <form action="insertventas.php" method="post">
            <h2>Insertar una venta</h2>

            <label for="idclien">ID cliente:</label>
            <input type="text" name="idclien" required>
            
            <label for="fecha">Día de la venta (Año-mes-día):</label>
            <input type="text" name="fecha" required> 
            
            <label for="imp">Importe:</label>
            <input type="text" name="imp" required>
            
            <label for="idpago">ID tipo de pago:</label>
            <input type="text" name="idpago" required>
            ...
            <input type="submit" name="submit" value="Insertar venta">
