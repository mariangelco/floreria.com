...
<head>
    ...
    <title>Floreria consulta ventas</title>
    <style>
        body {
...
<body>
    ...
    if ($result) {
        echo "<table>";
        echo "<tr><th>ID venta</th><th>ID cliente</th><th>Fecha</th><th>Importe</th><th>ID tipo de pago</th><th>ID producto</th><th>ID empleado</th></tr>";
